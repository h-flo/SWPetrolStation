 ...
 * 
 */
@WebServiceClient(name = "OrderService", targetNamespace = "http://service.swstelzer.stelzer.oth.de/", wsdlLocation = "http://im-lamport:8080/SWStelzer-0.3/OrderService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICE_QNAME = new QName("http://service.swstelzer.stelzer.oth.de/", "OrderService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://im-lamport:8080/SWStelzer-0.3/OrderService?wsdl");
    ...
    public OrderService getOrderServicePort() {
        return super.getPort(new QName("http://service.swstelzer.stelzer.oth.de/", "OrderServicePort"), OrderService.class);
    }
    ...
    public OrderService getOrderServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.swstelzer.stelzer.oth.de/", "OrderServicePort"), OrderService.class, features);
    }
